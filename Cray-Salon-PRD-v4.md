...
salon can open before setting up its own. If Crayora enters the salon's own account in the console during the trial, that
is used instead.
...
still withdraw consent. The block lifts the moment Crayora enters the salon's own account in the console.
